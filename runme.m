...
ntrials = length(T_f);
% pause for 0.1 seconds for technical reasons
pause(0.1)
%
% use TD model and find errors for each combination of properties
model_size_dist_elin
% defining a small (threshold) error
threshold_error=0.02;
...
bar(xbar,ybar,'c', 'baseValue',0.0001)
...
xlswrite('Results_error.xlsx',error')
